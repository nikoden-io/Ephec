...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(numbers); // Utilisation de la méthode Arrays.sort() pour trier le tableau

        System.out.println("Tableau trié par ordre croissant : " + Arrays.toString(numbers));
