...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Veuillez entrer la base (un entier) :");
        long base = s.nextLong();

        System.out.println("Veuillez entrer l'exposant (un entier) :");
        ...
        for (int i = 0; i < exponent; i++) {
            ...
            // Vérification pour éviter le dépassement de capacité
            if (result < 0) {
                System.out.println("Erreur: dépassement de capacité pour le résultat.");
                return;
            }
        }

        System.out.println(base + " élevé à la puissance de " + exponent + " est : " + result);
